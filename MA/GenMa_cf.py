...
class GenMa():
    ...
    def __init__(self, options):
        ...
        self.conn = pymysql.connect(host='192.168.0.56', port=3306, user='feadmin', passwd='feadmin000', db='sddb_cf')
    ...
    def genQueryCloseCmd(self, permid, date, rawName="*"):
        ...
        return f"SELECT {rawName} FROM fe_sec_dprc_raw WHERE datadate = {date} AND permid = {permid}"

    def genQuerySymCmd(self):
        return f"SELECT c.tic, c.permid FROM (SELECT a.permid,a.cshtrd,b.gvkey,b.tic FROM fe_sec_dprc_raw a,fe_security b WHERE a.datadate={self.asofdate} AND a.src=9930 AND a.opnInt!=0 AND a.cshtrd!=0 AND a.permid=b.permid ORDER BY a.cshtrd DESC LIMIT 100000) AS c GROUP BY c.gvkey"
...
if __name__ == "__main__":
    ...
    for date in dateArr:
        ...
        for sym in genMa.symMap.keys():
            ...
            if symInfo['ma5_0']<=symInfo['clo_0'] and symInfo['ma5_1']>symInfo['clo_1'] and symInfo['ma5_2']>symInfo['ma5_1'] and symInfo['ma5_0']>symInfo['ma5_1']:
